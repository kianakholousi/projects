...
for idx, filename in enumerate(os.listdir(folder_path)):
    ...
    if img is not None:
        ...
        superpixels_cetroids, S_intensities, S_dominant_colorss = superpixels_segmentation(img)
        ...
        graph1 = graph_euclidean(superpixels_cetroids)
        ...
        graph5 = graph_intensityS(superpixels_cetroids,S_intensities,T2)
        graph6 = graph_dominant_colorS(superpixels_cetroids,S_dominant_colorss,T3)
