...
cities = ["Abu Dhabi","Amsterdam","Ankara","Athens","Baghdad","Baku","Beijing","Beirut","Berlin","Cairo","Canberra","Doha","Helsinki","Kabul","London","Mexico City","Moscow","Rome","Seoul","Singapore","Stockholm","Tehran","Tokyo","Washington D.C."]
...
def handleUpdates(updates):
    for update in getResult(updates):
        ...
        if text == "/weather":
            ...
            sendMessage("for getting the Weather use the /weather command", chatId)
            ...
            sendMessage("each time you want a new weather report send the /weather command", chatId, keyboard)
